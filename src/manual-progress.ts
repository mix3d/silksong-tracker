 ...
 *
 * This module is now just a simple wrapper that updates the save data directly. Manual checkbox
 * selections modify the same save data structure that gets loaded from files.
 */
...
/** Set an item's value in the save data This is called when users manually check/uncheck items */
